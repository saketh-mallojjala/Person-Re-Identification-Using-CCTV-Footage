...
class YOLO3(object):
    def __init__(self):
        self.model_path = 'model_data/models/yolov3.h5'
        self.anchors_path = 'model_data/anchors/yolov3_anchors.txt'
        self.classes_path = 'model_data/classes/coco_classes.txt'
        self.score = 0.5
        self.iou = 0.5
